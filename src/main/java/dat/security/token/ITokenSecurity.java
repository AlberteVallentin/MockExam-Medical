...
import dat.security.token.TokenCreationException;
...
public interface ITokenSecurity {
     ...
     * @return a UserDTO object with email and a {@code Role}
     * @throws ParseException if there is an error during parsing the token
     */
    UserDTO getUserWithRoleFromToken(String token) throws ParseException;
    ...
    /**
     *
     * @param user a UserDTO object with email and a {@code Role}
